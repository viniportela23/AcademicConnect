...
// Lógica para inserção de dados de colaborador no banco de dados
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($foto['error'] === 0) {
        ...
        if ($foto_info !== false && $foto_info['mime'] === 'image/jpeg') {
            // Renomear a foto com o ID do colaborador
            $foto_nome = $idusuario . '_' . $idcolaborador . '.jpg'; // Adicione o idcolaborador ao nome
...
<body>    
  ...
  <div class="container mt-4">
    <h3>Inserir Dados do Colaborador</h3>
    <form method="post" action="add_colaborador.php" enctype="multipart/form-data">
      ...
      <button type="submit" class="btn btn-primary">Inserir Colaborador</button>
    </form>
  </div>
</body>
</html>
